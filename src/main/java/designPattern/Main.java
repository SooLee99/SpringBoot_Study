...
import designPattern.aop.AopProxy;
import designPattern.aop.IAopBrowser;
import designPattern.decorator.*;
import designPattern.facade.SftpClient;
import designPattern.observer.IButtonClickListener;
import designPattern.observer.MyButton;
import designPattern.proxy.BrowserProxy;
import designPattern.proxy.IBrowser;
import designPattern.singleton.AClazz;
import designPattern.singleton.BClazz;
import designPattern.strategy.Base64Strategy;
import designPattern.strategy.Encoder;
import designPattern.strategy.NormalStrategy;
